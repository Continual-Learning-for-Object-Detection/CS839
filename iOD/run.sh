# Base 2
python tools/train_net.py --num-gpus 4 --config-file ./configs/PascalVOC-Detection/iOD/base_2.yaml SOLVER.IMS_PER_BATCH 8 SOLVER.BASE_LR 0.005
# 2 + 2
sleep 10
python tools/train_net.py --num-gpus 4 --config-file ./configs/PascalVOC-Detection/iOD/2_p_2.yaml SOLVER.IMS_PER_BATCH 8 SOLVER.BASE_LR 0.005
# 2 + 2 _ ft
sleep 10
python tools/train_net.py --num-gpus 4 --config-file ./configs/PascalVOC-Detection/iOD/ft_2_p_2.yaml SOLVER.IMS_PER_BATCH 8 SOLVER.BASE_LR 0.005
